  ...
  return (
    <main className="p-8">
      ...
      <section className="mb-8" id="data-collection">
        ...
        Welcome to The Entrepreneurship Network (referred to as "we," "our," or "us"). We are committed to protecting and respecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website [insert website URL] or use our services. Please read this policy carefully to understand our views and practices regarding your personal data and how we will treat it.
        </p>
      ...
      <section className="mb-8" id="information-sharing">
        ...
        <p className="text-gray-700">
          ...
          <ul>
            ...
            <li>If The Entrepreneurship Network or substantially all of its assets are acquired by a third party, in which case personal data held by it about its customers will be one of the transferred assets.</li>
            <li>If we are under a duty to disclose or share your personal data in order to comply with any legal obligation, or in order to enforce or apply our terms of use and other agreements; or to protect the rights, property, or safety of The Entrepreneurship Network, our customers, or others.</li>
